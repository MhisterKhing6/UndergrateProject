...
class AssignmentStatistics extends Base {}
...
Course.init({
    ...
    totalScores: { // indicate if the mode of submission for assignment will be github
        type: DataTypes.INTEGER,
        default: 0
    },
    maxScore: { // indicate if the mode of submission for assignment will be github
        type: DataTypes.INTEGER,
        default: 0
    },
    worstScore: { // indicate if the mode of submission for assignment will be github
        type: DataTypes.INTEGER,
        default: 0
    },
